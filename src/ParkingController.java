import java.util.*;
/*
*implement parking controller class
* implement streetParking interface
 */

public class ParkingController implements StreetParking
{
    Deque<String> carList;
    ...
    //override toString method to debug
